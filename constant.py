...
# icebergs parameters
MIN_ICEBERGS = 3 # minimum number of icebergs should be 70
MAX_ICEBERGS = 5  # maximum number of icebergs should be 70
MIN_DOTS = 3  # min dots in each icebergs
MAX_DOTS = 10  # max dots in each icebergs
MIN_RADIUS = 60  # MIN radius size
MAX_RADIUS = 70  # MAX radius size - should be 45
