...
def test_convexhull_rectangle():
    ...
    result = [Point(0, 0),
              Point(1, 1),
              Point(0, 1)]
    assert ConvexHull(points).hull == result


def test_convexhull_straight_line():
    points = [
        Point(0, 0),
        Point(1, 1),
        Point(2, 2),
...
def test_convexhull_complex():
    # Complex input
    points = [Point(0.3215348546593775, 0.03629583077160248),
...
def test_convexhull_3dots():
    with pytest.raises(ValueError) as e:
        ConvexHull([Point(1, 2), Point(9, 5)])
    assert str(e.value) == 'need at least 3 dots'
